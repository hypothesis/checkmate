...
web: python
	@pyenv exec tox -qe dev --run-command 'gunicorn --bind :9099 --workers 1 --reload --timeout 0 --paste conf/development.ini'
...
docker:
	@git archive --format=tar HEAD | docker build -t hypothesis/checkmate:dev -
